...
public class ModBlocks {
    ...
    public static final DeferredRegister.Blocks BLOCKS =
            DeferredRegister.createBlocks(SunBlockCore.MODID);

    public static final DeferredBlock<PowerButton> POWER_BUTTON = registerBlock("power_button",
            () -> new PowerButton(BlockSetType.IRON, 10, BlockBehaviour.Properties.ofFullCopy(Blocks.STONE_BUTTON).strength(-1.0F, 3600000.0F)));

    public static final DeferredBlock<SolarSwitchBlock> SOLAR_SWITCH = registerBlock("solar_switch",
    ...
    public static final DeferredBlock<SolarLightSwitchBlock> SOLAR_LIGHT_SWITCH = registerBlock("solar_light_switch",
    ...
    private static <T extends Block> DeferredHolder<Item, Item> registerBlockItem(String name, DeferredBlock<T> block) {
